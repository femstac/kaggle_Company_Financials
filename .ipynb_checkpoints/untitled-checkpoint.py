...
def get_report_on_min_max_bar_values(bar_df,bar_x_axis, bar_y_axis):
    ...
    min_value = bar_df[y_axis].min()
    
    min_category = bar_df.loc[bar_df[bar_y_axis] == min_value, bar_x_axis].iloc[0]
    
    report = (f'The subcategory of **{bar_x_axis}** with the highest **{bar_y_axis}** value is **{max_category}** with a value of **{max_value}**. The subcategory of **{bar_x_axis}** with the lowest **{bar_y_axis}** value is **{min_category}** with a value of **{min_value}**.')
